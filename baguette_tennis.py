...
turtle.register_shape('baguette-tennis-images-and-sounds/jammie_dodger.gif')
turtle.register_shape('baguette-tennis-images-and-sounds/baguette_1_left.gif')
turtle.register_shape('baguette-tennis-images-and-sounds/baguette_2_right.gif')
...
baguette_1.shape("baguette-tennis-images-and-sounds/baguette_1_left.gif") # baguette_1 image
...
baguette_2.shape("baguette-tennis-images-and-sounds/baguette_2_right.gif") # baguette_2 image
...
# ball (Jammie Dodger)
ball = turtle.Turtle()
ball.shape("baguette-tennis-images-and-sounds/jammie_dodger.gif") # ball image
...
while True:
    ...
    if game_state == "title_screen": # checks game state           
        window.bgpic("baguette-tennis-images-and-sounds/title_screen.gif") # displays title screen
        ...
        if ball.ycor() > 270:
            ...
            winsound.PlaySound("baguette-tennis-images-and-sounds/splat_wall.wav", winsound.SND_ASYNC)
        ...
        if ball.xcor() < -325: # past baguette_1 and off screen
            ...
            pen.clear() # clears
            winsound.PlaySound("baguette-tennis-images-and-sounds/evil_laugh.wav", winsound.SND_ASYNC)
        ...
        # right side
            ...
            pen.clear() # clears
            winsound.PlaySound("baguette-tennis-images-and-sounds/win_point.wav", winsound.SND_ASYNC)
            pen.write("Detective: {}  /  Jamie Dodger: {}".format(human, computer), align="center", font=("Courier New", 16, "normal"))
        ...
        if ball.xcor() < -320 and ball.ycor() < baguette_1.ycor() + 100 and ball.ycor() > baguette_1.ycor() - 100:
            ...
            winsound.PlaySound("baguette-tennis-images-and-sounds/splat_baguette.wav", winsound.SND_ASYNC)
...
while True:
    if human_wins:
        window.bgcolor("black") # background colour
        window.bgpic("baguette-tennis-images-and-sounds/end_win_screen.gif")
        time.sleep(3)
        window.bye()             
        ...
        window.bgcolor("black") # background colour
        window.bgpic("baguette-tennis-images-and-sounds/end_lose_screen.gif")
        time.sleep(3)
        window.bye()
