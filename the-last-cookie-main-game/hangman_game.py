...
btn_font = pygame.font.Font("hangman-images/Peaberry-Mono.otf", 20)
letter_font = pygame.font.Font("hangman-images/Peaberry-Mono.otf", 40)
game_font = pygame.font.Font("hangman-images/Peaberry-Mono.otf", 25)
title_font = pygame.font.Font("hangman-images/Peaberry-Mono.otf", 30)
...
hangman_status = 0
for i in range(7):
    image = pygame.image.load(f'the-last-cookie-main-game/hangman-images/gingy{i}.png')
    IMAGES.append(image)
...
def title_screen():
    #screen.fill(PURPLE)
    castle = pygame.image.load('hangman-images/farquaad_castle.png')
    screen.blit(castle, (0, 0))
    logo = pygame.image.load('hangman-images/Save_Gingy_Logo_2.png')
