...
def main():
    ...
    room_5.set_description("You are stood in a damp and gloomy kitchen. There is an open oven. The warm aroma of "
                           "freshly baked bread wafts gently about you.")
    ...
    while True:
        ...
        if play.main_room_vists <= 1:
            play.sherlock_scones.set_conversation(
                "Hello there young Detective Digestive.\nTo solve the mystery of who ate "
                ...
                if play.current_room is not room_0:
                    ...
                    if decision == "y":
                        if play.current_room == room_1:
                            ...
                            play.clues.append(play.current_room.get_clue())
                            print("You see Lord Farquaad trying to pull off Gingy's gum drop button!"
                                  "Guess the dessert-related word to get the clue and save Gingy before he is broken "
                                  "apart")
                            os.startfile("hangman_game.exe")
                        elif play.current_room == room_3:
                            play.clues.append(play.current_room.get_clue())
                            print("You sit by the cookie mistress' desk, as you see a look of determination across her "
                                  "face. Who knows how this game will go?")
                            os.startfile("connect_four_game.exe")
                            ...
                            os.startfile("platformer.exe")
                        elif play.current_room == room_5:
                            play.clues.append(play.current_room.get_clue())
                            print("Suddenly you hear what sounds like a giant frisbee being harassed by a million "
                                  "wasps,and a massive Jammie Dodger biscuit begins hurtling towards you!\nQuick! "
                                  "Use your loaf!")
